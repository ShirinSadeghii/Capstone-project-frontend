...
const renderSignUp = () => (
  <form onSubmit={handleSignup} className="form_main">
  ...
  <div className="inputContainer">
      <img className="inputIcon"  src={nameIcon} alt="user icon" />
      <input type="text" className="inputField" id="name" placeholder="Name"/>
  </div>
  <div className="inputContainer">
      <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2e2e2e" viewBox="0 0 16 16">
